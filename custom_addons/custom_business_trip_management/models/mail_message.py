...
class MailMessage(models.Model):
    ...
    def _search(self, domain, offset=0, limit=None, order=None, access_rights_uid=None):
        ...
        Note: In Odoo 17, the 'count' parameter was removed from _search method.
        """
        ...
        return super(MailMessage, self)._search(domain, offset=offset, limit=limit, order=order, access_rights_uid=access_rights_uid)